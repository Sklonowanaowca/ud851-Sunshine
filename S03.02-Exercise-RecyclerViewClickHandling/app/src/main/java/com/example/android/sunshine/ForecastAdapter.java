...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    final private ForecastAdapterOnclickHandler mCllickHandler;
    ...
    interface ForecastAdapterOnclickHandler{
        ...
        void click(String weatherForToday);
    }
    ...
    public ForecastAdapter(ForecastAdapterOnclickHandler forecastAdapterOnclickHandler) {
        mCllickHandler = forecastAdapterOnclickHandler;
    }
    ...
    public class ForecastAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view) {
            int clickedWeather = getAdapterPosition();
            String weatherForToday = mWeatherData[clickedWeather];
            mCllickHandler.click(weatherForToday);
        }
    }
